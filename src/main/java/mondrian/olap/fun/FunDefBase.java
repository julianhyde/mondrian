...
public abstract class FunDefBase extends FunUtil implements FunDef {
     ...
     * arguments.
     *
     * <p>The default implementation makes the coarse assumption that the return
     ...
     *
     * <p>If the function definition says it returns a literal type (numeric,
     * string, symbol) then it's a fair guess that the function call
     * returns the same kind of value.
     *
     * <p>If the function definition says it returns an object type (cube,
