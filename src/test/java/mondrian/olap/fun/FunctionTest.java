...
public class FunctionTest extends FoodMartTestCase {
    ...
    public void testCrossJoinAsteriskQuery() {
        assertQueryReturns(
            ...
            + "Axis #2:\n"
            + "{[Store].[Stores].[USA].[CA], [Employee].[Position].[Middle Management]}\n"
            + "{[Store].[Stores].[USA].[CA], [Employee].[Position].[Senior Management]}\n"
            + "{[Store].[Stores].[USA].[CA], [Employee].[Position].[Store Full Time Staff]}\n"
            + "{[Store].[Stores].[USA].[CA], [Employee].[Position].[Store Management]}\n"
            + "{[Store].[Stores].[USA].[CA], [Employee].[Position].[Store Temp Staff]}\n"
            + "{[Store].[Stores].[USA].[OR], [Employee].[Position].[Middle Management]}\n"
            + "{[Store].[Stores].[USA].[OR], [Employee].[Position].[Senior Management]}\n"
            + "{[Store].[Stores].[USA].[OR], [Employee].[Position].[Store Full Time Staff]}\n"
            + "{[Store].[Stores].[USA].[OR], [Employee].[Position].[Store Management]}\n"
            + "{[Store].[Stores].[USA].[OR], [Employee].[Position].[Store Temp Staff]}\n"
            + "{[Store].[Stores].[USA].[WA], [Employee].[Position].[Middle Management]}\n"
            + "{[Store].[Stores].[USA].[WA], [Employee].[Position].[Senior Management]}\n"
            + "{[Store].[Stores].[USA].[WA], [Employee].[Position].[Store Full Time Staff]}\n"
            + "{[Store].[Stores].[USA].[WA], [Employee].[Position].[Store Management]}\n"
            + "{[Store].[Stores].[USA].[WA], [Employee].[Position].[Store Temp Staff]}\n"
            + "Row #0: $275.40\n"
            + "Row #0: $275.40\n"
            + "Row #0: $275.40\n"
            + "Row #0: $275.40\n"
