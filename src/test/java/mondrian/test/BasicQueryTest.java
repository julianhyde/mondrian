...
public class BasicQueryTest extends FoodMartTestCase {
    ...
    public void testGetContext() {
        ...
        assertEquals(
            "[Time].[Time].[1997]",
            cell.getContextMember(hierarchyMap.get("[Time].[Time]"))
                .getUniqueName());
        assertEquals(
        ...
        assertEquals(
            "[Customer].[Gender].[All Gender]",
            cell.getContextMember(hierarchyMap.get("[Customer].[Gender]"))
                .getUniqueName());
        assertEquals(
            "[Customer].[Marital Status].[S]",
            cell.getContextMember(
                hierarchyMap.get("[Customer].[Marital Status]"))
                .getUniqueName());
    }
    ...
    public void testUseHierarchyAsShorthandForMember() {
        Util.discard(
            executeQuery(
                "select {[Measures].[Unit Sales]} on columns,\n"
    ...
    public void testExplain() throws SQLException {
        ...
        TestContext.assertEqualsVerbose(
            ...
            + "    UnarySublistCalc(name=UnarySublistCalc, class=class mondrian.olap.fun.SetFunDef$UnarySublistCalc, type=MemberType<member=[Measures].[Unit Sales]>, resultStyle=VALUE)\n"
            ...
            + "    ChildrenCalc(name=ChildrenCalc, class=class mondrian.olap.fun.ChildrenFunDef$ChildrenCalc, type=SetType<MemberType<hierarchy=[Product].[Products]>>, resultStyle=LIST)\n"
            ...
            + "    GtNumericCalc(name=GtNumericCalc, class=class mondrian.olap.fun.BuiltinFunTable$GtNumericCalc, type=BOOLEAN, resultStyle=VALUE)\n"
    ...
    public void testExplainComplex() throws SQLException {
        ...
        TestContext.assertEqualsVerbose(
            ...
            + "    UnarySublistCalc(name=UnarySublistCalc, class=class mondrian.olap.fun.SetFunDef$SetListCalc$UnarySublistCalc, type=MemberType<member=[Customer].[Gender].[F]>, resultStyle=VALUE)\n"
            ...
            + "Axis (COLUMNS):\n"
            + "SetListCalc(name=SetListCalc, class=class mondrian.olap.fun.SetFunDef$SetListCalc, type=SetType<MemberType<member=[Measures].[Unit Sales]>>, resultStyle=MUTABLE_LIST)\n"
            + "    UnarySublistCalc(name=UnarySublistCalc, class=class mondrian.olap.fun.SetFunDef$SetListCalc$UnarySublistCalc, type=MemberType<member=[Measures].[Unit Sales]>, resultStyle=VALUE)\n"
            + "        Literal(name=Literal, class=class mondrian.calc.impl.ConstantCalc, type=MemberType<member=[Measures].[Unit Sales]>, resultStyle=VALUE_NOT_NULL, value=[Measures].[Unit Sales])\n"
            + "    UnarySublistCalc(name=UnarySublistCalc, class=class mondrian.olap.fun.SetFunDef$SetListCalc$UnarySublistCalc, type=MemberType<member=[Measures].[Store Margin]>, resultStyle=VALUE)\n"
            ...
            + "    NamedSetCalc(name=NamedSetCalc, class=class mondrian.mdx.NamedSetExpr$NamedSetCalc, type=SetType<MemberType<member=[Product].[Products].[Drink]>>, resultStyle=ITERABLE)\n"
            + "    HierarchyMembersCalc(name=HierarchyMembersCalc, class=class mondrian.olap.fun.BuiltinFunTable$HierarchyMembersCalc, type=SetType<MemberType<hierarchy=[Customer].[Marital Status]>>, resultStyle=MUTABLE_LIST)\n"
